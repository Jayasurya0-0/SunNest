...
<head>
    ...
    <title>Sign Up - SunNest Solar Warmth Solutions</title>
            ...
            <div class="bg-white py-8 px-4 shadow-xl rounded-xl sm:px-10 border border-gray-100">
                ...
                <form id="signup-form" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <button type="button"
                                class="absolute right-3 top-1/2 transform -translate-y-1/2 w-5 h-5 flex items-center justify-center text-gray-400 hover:text-gray-600">
                                <i class="ri-eye-line text-sm toggle-confirm-password"></i>
                            </button>
                        </div>
                    </div>
                    <div class="flex items-start">
                        <input id="terms" name="terms" type="checkbox" class="sr-only">
                        <div
                            class="w-4 h-4 border-2 border-gray-300 rounded-sm flex items-center justify-center cursor-pointer terms-checkbox mt-0.5">
                            <i class="ri-check-line text-white text-xs hidden check-icon"></i>
                        </div>
                        <label for="terms" class="ml-3 block text-sm text-gray-700 cursor-pointer leading-5">
                            I agree to the <a href="#" class="text-primary hover:text-blue-600 transition-colors">Terms
                                of Service</a> and <a href="#"
                                class="text-primary hover:text-blue-600 transition-colors">Privacy Policy</a>
                        </label>
                    </div>
                    <div>
                        <button type="submit"
                            class="w-full bg-primary text-white py-3 px-4 rounded-button font-medium hover:bg-blue-600 transition-colors whitespace-nowrap">Create
                            Account</button>
                    </div>
                    <div class="relative">
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="login.php"
                            data-readdy="true"
                            class="text-primary hover:text-blue-600 font-medium transition-colors">Sign in</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            toggleConfirmButton.addEventListener('click', function () {
                if (confirmPasswordInput.type === 'password') {
                    ...
                    toggleConfirmButton.classList.remove('ri-eye-line');
                    toggleConfirmButton.classList.add('ri-eye-off-line');
                } else {
                    confirmPasswordInput.type = 'password';
                    toggleConfirmButton.classList.remove('ri-eye-off-line');
                    toggleConfirmButton.classList.add('ri-eye-line');
                }
            });
        });
    </script>
